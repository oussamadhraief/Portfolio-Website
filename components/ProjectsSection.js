...
export default function ProjectsSection(){
    return (
        <div id="ProjectsPart" className='h-72 mt-5 space-y-3'>
            <ProjectComponent linkToProject="https://github.com/oussamadhraief/Oussama-Dhraief-Portfolio" projectTitle="Portfolio-Website" projectDescription="This is my portfolio website." stars="17" forks="8" />
