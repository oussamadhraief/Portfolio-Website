...
export default function EducationLink(){
    ...
    className="transition delay-75 whitespace-nowrap text-white my-5 ml-1 text-xl font-semibold hover:cursor-pointer bg-gray-900 rounded-r-xl pr-14 h-fit" id="educationLink">
        <Image className="bg-gray-900 m-0" src={educationIcon} width={25} height={25} quality={100} alt="Student Icon"/>
        &nbsp;&nbsp;&nbsp;&nbsp;Education
        </span>
    )
}