...
export default function Home() {
  ...
  return (
    ...
    <LoadingContext.Provider value={{loading,setLoading}}>
      <Head>
        <title>Oussama Dhraief - Full-Stack Developer (MERN Stack)</title>
        ...
        <meta itemProp="name" content="Oussama Dhraief - Full-Stack Developer (MERN Stack)"/>
        <meta itemProp="description" content="A passionate software developer with great ambitions."/>
        <meta property="og:title" content="Oussama Dhraief - Full-Stack Developer (MERN Stack)"/>
        ...
        <meta name="twitter:title" value="Oussama Dhraief - Full-Stack Developer (MERN Stack)"/>
