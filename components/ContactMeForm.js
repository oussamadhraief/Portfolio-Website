...
const handleSubmit = async () => {
    ...
    if(submitted) 
    return (
        <div className="grid space-y-5 w-full md:w-5/6 lg:w-4/6 py-20 md:p-5 h-full rounded-xl text-medium font-bold text-center text-gray-900 animate-[bounce_1s] content-center">
            Sent ✔️
            <br></br>
    ...
    return(
        <form action="submit" onSubmit={(e) => {
            ...
            <input type="submit" name="submit" className="bg-gray-900 w-fit mt-3 px-3 py-2 md:px-6 md:py-3 rounded-2xl font-bold text-xl font-mono text-white hover:bg-yellow-500 hover:scale-110 hover:cursor-pointer mx-auto my-10" />
           {loading ? <div id='loading' className="flex w-full h-full md:h-[93%] justify-center items-center text-gray-900 rounded-xl text-center text-lg font-extrabold absolute overflow-hidden">
